      ...
      {modal && (
        <div className="md:w-[95%] bg-white fixed md:top-[1rem] px-4 py-6 md:py-[5rem] md:px-8 flex flex-col md:flex-row justify-between gap-5 md:gap-[7rem] overflow-y-visible">
          ...
          <div className="flex flex-col gap-3 md:gap-7 md:w-[35%] pt-12">
            ...
            <div className="hidden md:flex gap-3">
              <div className="space-y-6 text-gray-600 pl-4">
                <p className="mb-[-22px] font-normal ml-[23px] text-[12px]">
                  YOU ARE HERE
                </p>
            ...
            <div className="flex text-[14px] gap-2 md:flex-col md:space-y-2 md:mb-6">
              <h1 className="md:text-[17px] text-gray-600">
          ...
          <div className="md:w-[65%] md:mt-6">
            <div
              className="flex justify-end text-gray-500 absolute top-[2rem] right-[2.5rem] text-[1.5em] cursor-pointer"
              onClick={() => onClose()}
            >
              <VscChromeClose />
            </div>
            <form>
              <div className="flex flex-col gap-5 md:gap-9 text-black">
                <div className="flex flex-col gap-2 md:flex-row">
                  <label
                    className="after:content-['*'] after:ml-1 after:text-red-500 font-normal md:font-medium text-[13px]"
                    htmlFor="name"
                  >
                    My Name
                  </label>
                  <input
                    className="border-b border-gray-400 outline-none text-[11px] focus:outline-none md:ml-4 md:w-[33rem] font-medium pb-1 md:pb-2 hover:border-blue-500"
                    id="name"
                ...
                <div className="flex flex-col gap-2 md:flex-row">
                  ...
                  <input
                    className="border-b border-gray-400 outline-none text-[11px] focus:outline-none md:ml-10 md:w-[33rem] font-medium pb-1 md:pb-2 hover:border-blue-500"
                    id="email"
                ...
                <div className="flex flex-col gap-2 md:flex-row">
                  ...
                  <textarea
                    className="md:w-[33rem] text-[11px] md:ml-4 border-b border-gray-400 outline-none focus:outline-none hover:border-blue-500 pb-[1px]"
                    id="message"
              ...
              <div className="mt-4 text-[10px] md:text-[13px] md:ml-[5.5rem] text-gray-500 font-medium">
                ...
                <p>
                  appropriate information. This site is protected by reCAPTCHA
                  and the Google{" "}
                  <span className="text-red-500 cursor-pointer">
                    Privacy Policy{" "}
                  </span>
              ...
              <div className="mt-5 md:mt-8 flex justify-between items-center pr-2">
                <label className={styles.fileInputLabel}>
                  ...
                  <div className="flex items-center gap-2">
                    <IoMdAttach style={{ fontSize: "20px" }} />
                    Attach File
                  </div>
                </label>
                <button className="bg-red-400 w-[10rem] md:w-[16rem] text-white px-10 py-3 text-[17px] hover:bg-transparent hover:text-red-400 hover:border hover:border-red-500">
                  Send
                </button>
              </div>
            </form>
