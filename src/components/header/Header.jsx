...
const Header = () => {
  ...
  return (
    <>
      ...
      <div
        data-aos="fade-up"
        className="relative  w-screen pt-20  "
        // style={{
        //   background:
        ...
        >
          ...
          >
            <motion.div
              ...
              className="text-[37px]  md:text-[5rem] font-medium px-6 text-2xl text-center mt-6 md:mt-0 md:px-40 leading-snug"
            >
              <h1 className="">
          ...
          <div
            className="flex header-image justify-center mt-[30px] p-8 overflow-x-hidden md:mt-20"
            // data-aos="zoom-in"
          >
            {/* {image && (
              <Image
