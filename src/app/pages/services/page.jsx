...
const Services = () => {
  return (
    <div className="bg-black min-h-screen w-full flex flex-col justify-center items-center relative overflow-hidden">
      ...
      {/* Purple glow effect */}
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full h-96 w-96 opacity-50 z-0"
        style={{
          background:
            "radial-gradient(circle, rgba(128,0,128,0.8), rgba(0,0,0,0.8))",
        }}
      ></div>

      {/* Heading */}
      <h1 className="text-white text-5xl font-bold mb-12 z-10 relative">
        Our Services
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 z-10 relative">
        ...
        {/* Service Column 3 */}
        <div>
          <h2 className="text-white text-3xl mb-4">{uiuxIcon}UI/UX Design</h2>
          <ul className="list-disc list-inside text-white">
